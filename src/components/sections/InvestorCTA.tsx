    ...
    return (
        <section className="section relative overflow-hidden">
            ...
            <div className="container max-w-7xl mx-auto relative z-10">
                ...
                >
                    <div className="relative bg-white/[0.03] backdrop-blur-lg border border-white/[0.06] rounded-2xl p-10 md:p-14 overflow-hidden">
                        ...
                        <span className="text-sm font-mono text-cyan-400 tracking-widest uppercase mb-6 block">
